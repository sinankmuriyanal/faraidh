     ...
     divide:(number)=>{
        ...
        if(number.husband==1) {
            if(((number.son==0) &&(number.daughter==0)) && (number.grandSon==0 && number.grandDaughter==0)  ) {
                ...
                exp.push("പരേതക്ക് മക്കളില്ലാത്തതിനാല്‍ ഭർത്താവിന് തന്‍റെ വിഹിതമായ 1/2 ലഭിക്കുന്നു");
            }else if(((number.son>=1) ||(number.daughter>=1)) || (number.grandSon>=1 || number.grandDaughter>=1)  ){
                husbandgets=25;
                
                exp.push("പരേതക്ക് മക്കളുള്ളതിനാല്‍ ഭർത്താവിന് തന്‍റെ വിഹിതമായ 1/4 ലഭിക്കുന്നു");
            }
        }
        ...
        if((number.son==0 && number.daughter==0) &&  (number.grandSon==0 && number.grandDaughter==0) ) {
            if((number.father==0 && number.grandFather==0)){
                if(number.fullBrother==0 && number.fullSister==1) {
                    fullSistergets=50;
                    exp.push("പൂർണ്ണ സഹോദരിക്ക് തന്‍റെ വിഹിതമായ 1/2 ലഭിക്കുന്നു");

                }else if(number.fullBrother==0 && number.fullSister>1) {
                    fullSistergets= ((2/3)*100);
                    exp.push("പൂർണ്ണ സഹോദരിമാർക്ക് തങ്ങളുടെ വിഹിതമായ 2/3 ലഭിക്കുന്നു");
                }
            }
        ...
        if((number.son==0 && number.daughter==0) &&  (number.grandSon==0 && number.grandDaughter==0) ) {
            ...
            if(number.paternalBrother==0 && number.paternalSister==1) {
                ...
                exp.push("ഏകപിതാ സഹോദരിക്ക് തന്‍റെ വിഹിതമായ 1/2 ലഭിക്കുന്നു");
            }else if(number.paternalBrother==0 &&number.paternalSister>1) {
                paternalSistergets= ((2/3)*100);
                exp.push("ഏകപിതാ സഹോദരിമാർക്ക് തങ്ങളുടെ വിഹിതമായ 2/3 ലഭിക്കുന്നു");
            }
        }
        ...
        if(number.son==0) {
            if(number.daughter==1) {
                daughtergets=50;
                exp.push("മകള്‍ക്ക് തന്‍റെ വിഹിതമായ 1/2 ലഭിക്കുന്നു");

            }else if(number.daughter>1) {
                daughtergets= ((2/3)*100);
                exp.push("പെണ്‍ മക്കള്‍ക്ക് തങ്ങളുടെ വിഹിതമായ 2/3 ലഭിക്കുന്നു");
            }
        }
        ...
        if(number.son==0 && number.daughter==0) {
            if(number.grandSon==0 && number.grandDaughter==1) {
                ...
                exp.push("പേരമകള്‍ക്ക് തന്‍റെ വിഹിതമായ 1/2 ലഭിക്കുന്നു");
            }else if(number.grandSon==0 && number.grandDaughter>1) {
                grandDaughtergets= ((2/3)*100);
                exp.push("മകന്‍റെ പെണ്‍ മക്കള്‍ക്ക് തങ്ങളുടെ വിഹിതമായ 2/3 ലഭിക്കുന്നു");
            }
        } 
        ...
        if(number.wife>=1) {
            if((number.son==0) &&(number.daughter==0)) {
                wifegets=25;
                exp.push("പരേതന് മക്കളില്ലാത്തതിനാല്‍ ഭാര്യക്ക് തന്‍റെ വിഹിതമായ 1/4 ലഭിക്കുന്നു");
            }else {
                wifegets=12.5;
                
                exp.push("പരേതന് മക്കളുള്ളതിനാല്‍ ഭാര്യക്ക് തന്‍റെ വിഹിതമായ 1/8 ലഭിക്കുന്നു" )
            }
        }
        ...
        if(number.father==1) {
            ...
            fathergets= ((1/6)*100);
            exp.push("പിതാവിന് തന്‍റെ വിഹിതമായ 1/6 ലഭിക്കുന്നു");
            }
        }
        ...
        if(number.mother==1) {
            if(((number.son==0) && (number.daughter==0)) && ((havashi<2))) {
                mothergets= ((1/3)*100);
                exp.push("മാതാവിന് തന്‍റെ വിഹിതമായ 1/3 ലഭിക്കുന്നു");
            }else {
                mothergets= ((1/6)*100);
                exp.push("മാതാവിന് തന്‍റെ വിഹിതമായ 1/6 ലഭിക്കുന്നു");
            }
        }
        ...
        if((number.father==1) && (number.mother==1)) {
            ...
            if( othersofumariyya==0){
                if(number.husband==1) {
                    mothergets= ((1/6)*100);
                    exp.push("പരേതന്‍റെ പിതാവിനും ഭർത്താവിനും ഒപ്പമായതിനാല്‍ മാതാവിന് 1/6 ലഭിക്കുന്നു.")
                    fathergets= ((1/3)*100);
                    exp.push("പരേതന്‍റെ മാതാവിനും ഭർത്താവിനും ഒപ്പമായതിനാല്‍ പിതാവിന് 1/3 ലഭിക്കുന്നു.")
                }else if(number.wife>=1) {
                    mothergets=25;
                    exp.push("പരേതന്‍റെ പിതാവിനും ഭാര്യക്കും ഒപ്പമായതിനാല്‍ മാതാവിന് 1/4 ലഭിക്കുന്നു.")
                    fathergets=50;
                    exp.push("പരേതന്‍റെ മാതാവിനും ഭാര്യക്കും ഒപ്പമായതിനാല്‍ പിതാവിന് 1/2 ലഭിക്കുന്നു.")
                }
            }   
        }
        ...
        if((number.daughter==1 && number.grandDaughter>=1) &&(number.son==0 && number.grandSon==0)){
            ...
            exp.push("പരേതന് മകളുണ്ടായതിനാല്‍ പേരമകള്‍ക്ക് തന്‍റെ വിഹിതമായ 1/6 ലഭിക്കുന്നു");
        }
        ...
        if((number.fullSister==1 && number.paternalSister>=1)&&(number.son==0 && number.daughter==0)){
            if(number.paternalBrother==0){
                ...
                exp.push("പരേതന് പൂർണ്ണ സഹോദരി ഉണ്ടായതിനാല്‍ ഏകപിതാ സഹോദരിക്ക് തന്‍റെ വിഹിതമായ 1/6 ലഭിക്കുന്നു");
            }
        }
        if((number.son==0 && number.daughter==0) && (number.father==0 && number.grandFather==0)){
            ...
            exp.push("ഏകമാതാ സഹോദരന് തന്‍റെ വിഹിതമായ 1/6 ലഭിക്കുന്നു")
        }else if(number.maternalBrother>=2 && number.maternalSister==0){
            maternalBrothergets= ((1/3)*100);
            exp.push("ഏകപിതാ സഹോദരന്‍മാർക്ക് തങ്ങളുടെ വിഹിതമായ 1/3 ലഭിക്കുന്നു")
            }
        }
        ...
        if((number.son==0 && number.daughter==0) && (number.father==0 && number.grandFather==0)){
            if(number.maternalSister==1 && number.maternalBrother==0){
                ...
                exp.push("ഏകമാതാ സഹോദരിക്ക് തന്‍റെ വിഹിതമായ 1/6 ലഭിക്കുന്നു")
                     }else if(number.maternalSister>=2 && number.maternalBrother==0){
                maternalSistergets= ((1/3)*100);
                exp.push("ഏകമാതാ സഹോദരിമാർക്ക് തങ്ങളുടെ വിഹിതമായ 1/3 ലഭിക്കുന്നു")
                    ...
                    exp.push("ഏകമാതാ സഹോദരിയും സഹോദരനും 1/3 അവർക്കിടയില്‍ തുല്യമായി വീതിച്ചെടുക്കുന്നു.")
        ...
        if((number.grandMother==1 && number.mother==0)&& (number.grandMother2==0)){
            ...
            exp.push("മാതാവില്ലാത്തതിനാല്‍ പിതാമഹിക്ക് തന്‍റെ വിഹിതമായ 1/6 ലഭിക്കുന്നു")
            
        }
        if((number.grandMother2==1 && number.mother==0)&& (number.grandMother==0)){
            grandMother2gets= ((1/6)*100);
            exp.push("മാതാവില്ലാത്തതിനാല്‍ മാതാമഹിക്ക് തന്‍റെ വിഹിതമായ 1/6 ലഭിക്കുന്നു")
        }
        if((number.grandMother2==1 && number.mother==0)&& (number.grandMother==1)){
            grandMother2gets= ((1/12)*100);
            grandMothergets= ((1/12)*100);
            exp.push("മാതാമഹിയും പിതാമഹിയും 1/6 അവർക്കിടയില്‍ തുല്യമായി വീതിച്ചെടുക്കുന്നു.")
        }

        if(number.father==0 && number.grandFather==1){
            grandFathergets= ((1/6)*100);
  
            exp.push("പിതാവില്ലാത്തതിനാല്‍ പിതാമഹന് തന്‍റെ വിഹിതമായ 1/6 ലഭിക്കുന്നു")
        }
       ...
       /*************          ASABA               ********* */
        ...
        if(balance>1) {
            ...
            songets=balance;
            exp.push("ബാക്കി പൂർണ്ണമായും മകന് ലഭിക്കുന്നു.")
                ...
                var shares= parseFloat(shares);
                 ...
                 exp.push("ബാക്കി മകനും മകളും 2:1 എന്ന അനുപാതത്തില്‍ വീതിച്ചെടുക്കുന്നു.")
            }
            
            if(number.son==0) {
                if(number.grandSon>=1 && number.grandDaughter==0) {
                grandSongets=balance;
                exp.push("ബാക്കി പൂർണ്ണമായും പേരമകന് ലഭിക്കുന്നു.")
                 ...
                 exp.push("ബാക്കി പേരമകനും പേരമകളും 2:1 എന്ന അനുപാതത്തില്‍ വീതിച്ചെടുക്കുന്നു.")
                }
            }
            ...
            if(number.son==0 && number.grandSon==0 ) {
                ...
                exp.push("പരേതന് മക്കളില്ലാത്തതിനാല്‍ ബാക്കി പൂർണ്ണമായും പിതാവിന് ലഭിക്കുന്നു.")
                }
            }
            ...
            var brothers=number.fullBrother+number.fullSister+number.paternalBrother+number.paternalSister;
                if ((number.husband==1 && number.mother==1) &&(number.grandFather==1 && number.fullSister==1)){
                    ...
                    exp.pop();
                    exp.push("പരേതന് മക്കളോ പിതാവോ ഇല്ലാത്തതിനാല്‍ ബാക്കി പൂർണ്ണമായും പിതാമഹന് ലഭിക്കുന്നു.")
                    } 
            ...
            if(((number.son==0 && number.grandSon==0) && (number.father==0)) &&(number.grandFather==0)) {
                ...
                console.log(balance);
                exp.push("ബാക്കി പൂർണ്ണമായും പൂർണ്ണ സഹോദരന് ലഭിക്കുന്നു.")
                    ...
                    exp.push("ബാക്കി പൂർണ്ണ സഹോദരനും പൂർണ്ണ സഹോദരിയും 2:1 എന്ന അനുപാതത്തില്‍ വീതിച്ചെടുക്കുന്നു.")
                }
            }
            ...
            if((((number.son==0 && number.grandSon==0) && (number.father==0 &&  number.fullSister==0)) &&(number.grandFather==0)) && number.fullBrother==0) {
                ...
                exp.push("ബാക്കി പൂർണ്ണമായും ഏകപിതാ സഹോദരന് ലഭിക്കുന്നു.")
                    ...
                    exp.push("ബാക്കി ഏകപിതാ സഹോദരനും ഏകപിതാ സഹോദരിയും 2:1 എന്ന അനുപാതത്തില്‍ വീതിച്ചെടുക്കുന്നു.")
                }
            }
            if((((number.son==0 && number.grandSon==0) && (number.father==0 &&  number.grandFather==0))
             &&(number.fullBrother==0)) && number.paternalBrother==0) {
                if(number.nephew2>=1 ) {
                    nephew2gets=balance;
                    exp.push("ബാക്കി പൂർണ്ണമായും പൂർണ്ണ സഹോദരന്‍റെ പുത്രന് ലഭിക്കുന്നു.")
                }
            }
            ...
            &&(number.fullBrother==0)) && number.paternalBrother==0) {
               if(number.nephew2==0 && number.nephew1>=1) {
                   nephew1gets=balance;
                   exp.push("ബാക്കി പൂർണ്ണമായും ഏകപിതാ സഹോദരന്‍റെ പുത്രന് ലഭിക്കുന്നു.")
               }
           }
           ...
           if((((number.son==0 && number.grandSon==0) && (number.father==0 &&  number.grandFather==0))
            &&(number.fullBrother==0)) && number.paternalBrother==0) {
               if(number.nephew2==0 && number.nephew1==0) {
                if(number.uncle2>=1 ) {
                    uncle2gets=balance;
                    exp.push("ബാക്കി പൂർണ്ണമായും പിതാവിന്‍റെ പൂർണ്ണ സഹോദരന് ലഭിക്കുന്നു.")
                    }
               }
           }
           ...
           &&(number.fullBrother==0)) && number.paternalBrother==0) {
              if(number.nephew2==0 && number.nephew1==0) {
               if(number.uncle2==0 && number.uncle1>=1) {
                   uncle1gets=balance;
                   exp.push("ബാക്കി പൂർണ്ണമായും പിതാവിന്‍റെ ഏകപിതാ സഹോദരന് ലഭിക്കുന്നു.")
                   }
              }
          }
           ...
           &&(number.fullBrother==0)) && number.paternalBrother==0) {
              if(number.nephew2==0 && number.nephew1==0) {
               if(number.uncle2==0 && number.uncle1==0) {
                if(number.cousin2>=1 ) {
                   cousin2gets=balance;
                   exp.push("ബാക്കി പൂർണ്ണമായും പിതാവിന്‍റെ പൂർണ്ണ സഹോദരപുത്രന് ലഭിക്കുന്നു.")
                }
                   }
              }
          }
              ...
              if(number.nephew2==0 && number.nephew1==0) {
               if(number.uncle2==0 && number.uncle1==0) {
                if(number.cousin2==0 && number.cousin1>=1) {
                    cousin1gets=balance;
                    exp.push("ബാക്കി പൂർണ്ണമായും പിതാവിന്‍റെ ഏകപിതാ സഹോദരപുത്രന് ലഭിക്കുന്നു.")
                 }
                   }
              }
          }
            ...
            if(number.daughter>=1 || number.grandDaughter>=1){
                if(number.son==0 && number.grandSon==0){
                    if(number.fullSister>=1 && number.fullBrother==0){
                        ...
                        exp.push("മകള്‍ക്കോ പേരമകള്‍ക്കോ ഒപ്പം പൂർണ്ണ സഹോദരി മാത്രം അവശേഷിച്ചതിനാല്‍ അവർക്ക് ബാക്കി പൂർണ്ണമായും ലഭിക്കുന്നു.")
                            ...
                            if(number.fullSister==0 && number.fullBrother==0){
                                ...
                                exp.push("മകള്‍ക്കോ പേരമകള്‍ക്കോ ഒപ്പം ഏകപിതാ സഹോദരി മാത്രം അവശേഷിച്ചതിനാല്‍ അവർക്ക് ബാക്കി പൂർണ്ണമായും ലഭിക്കുന്നു.")
                            }
...
if(number.son>=1 && number.grandSon>=1) {
    grandSongets=0;
    exp.push("പേരമകനെ മകന്‍ അനന്തരസ്വത്തില്‍ നിന്നും തടയുന്നു.")
}

if(number.father>=1  && number.grandFather>=1) {
    grandFathergets=0;
    exp.pop();
    exp.push("പിതാമഹനെ പിതാവ് അനന്തരസ്വത്തില്‍ നിന്നും തടയുന്നു.")
}
if((number.son >=1 && number.daughter>=1) && number.grandDaughter>=1){
    grandDaughtergets=0;
    exp.push(" മകനും മകളും ഒരുമിച്ചുണ്ടെങ്കില്‍  പേരമകള്‍ അനന്തരസ്വത്തില്‍ നിന്നും തടയെപ്പുടുന്നു.")
}
    ...
    exp.push("ഏകമാതാ സഹോദരനെയും സഹോദരിയേയും പിതാവും മകനും അനന്തരസ്വത്തില്‍ നിന്നും തടയുന്നു.")
}

if(number.mother>=1  && (number.grandMother>=1 || number.grandMother2>=1 )) {
    grandMother2gets=0;
    grandMothergets=0
    exp.push("പിതാമഹിയേയും മാതാമഹിയേയും മാതാവ് അനന്തരസ്വത്തില്‍ നിന്നും തടയുന്നു.")
}

if((number.father==1 || number.son>=1 || number.grandSon>=1)  && number.fullBrother>=1) {
    fullBrothergets=0;
    exp.push("പൂർണ്ണ സഹോദരനെ പിതാവും മകനും പേരമകനും അനന്തരസ്വത്തില്‍ നിന്നും തടയുന്നു.")
}

if((number.father==1 || number.son>=1 || number.grandSon>=1 || number.fullBrother>=1)  && number.paternalBrother>=1) {
    paternalBrothergets=0;
    exp.push("ഏകപിതാ സഹോദരനെ പിതാവും മകനും പേരമകനും പൂർണ്ണ സഹോദരനും അനന്തരസ്വത്തില്‍ നിന്നും തടയുന്നു.")
}

if((number.father==1 || number.son>=1 || number.grandSon>=1 || number.fullBrother>=1  || number.paternalBrother>=1) && number.nephew2>=1) {
    nephew2gets=0;
    exp.push(" സഹോദരപുത്രനെ പിതാവും മകനും പേരമകനും സഹോദരനും അനന്തരസ്വത്തില്‍ നിന്നും തടയുന്നു.")
}
...
if((number.father==1 || number.son>=1 || number.grandSon>=1 || number.fullBrother>=1  || number.paternalBrother>=1 || number.nephew2>=1) && number.nephew1>=1) {
    nephew1gets=0;
    exp.push(" ഏകപിതാ സഹോദരപുത്രനെ പിതാവും മകനും പേരമകനും സഹോദരനും പൂർണ്ണ  സഹോദരപുത്രനും അനന്തരസ്വത്തില്‍ നിന്നും തടയുന്നു.")
}
if((number.father==1 || number.son>=1 || number.grandSon>=1 || number.fullBrother>=1  || number.paternalBrother>=1 || number.nephew2>=1 || number.nephew1>=1) && number.uncle2>=1) {
    uncle2gets=0;
    exp.push(" പിത്യവ്യനെ പിതാവും മകനും പേരമകനും സഹോദരനും സഹോദരപുത്രനും അനന്തരസ്വത്തില്‍ നിന്നും തടയുന്നു.")
}
if((number.father==1 || number.son>=1 || number.grandSon>=1 || number.fullBrother>=1  || number.paternalBrother>=1 
    || number.nephew2>=1 || number.nephew1>=1 || number.uncle2>=1) && number.uncle1>=1) {
    uncle1gets=0;
    exp.push("ഏകപിതാ പിത്യവ്യനെ പിതാവും മകനും പേരമകനും സഹോദരനും സഹോദരപുത്രനും പൂർണ്ണ പിതൃവ്യനും അനന്തരസ്വത്തില്‍ നിന്നും തടയുന്നു.")
}
if((number.father==1 || number.son>=1 || number.grandSon>=1 || number.fullBrother>=1  || number.paternalBrother || number.nephew2 
    || number.nephew2>=1 || number.uncle1>=1 ) && number.cousin2>=1) {
        cousin2gets=0;
        exp.push(" പിതൃവ്യപുത്രനെ പിതാവും മകനും പേരമകനും സഹോദരനും സഹോദരപുത്രനും പിതൃവ്യനും അനന്തരസ്വത്തില്‍ നിന്നും തടയുന്നു.")
}
if((number.father==1 || number.son>=1 || number.grandSon>=1 || number.fullBrother>=1  || number.paternalBrother || number.nephew2 
    || number.nephew1>=1 || number.uncle1>=1 || number.nephew2>=1 || number.cousin2>=1) && number.cousin1>=1) {
        cousin1gets=0;
        exp.push(" ഏകപിതാ പിതൃവ്യപുത്രനെ പിതാവും മകനും പേരമകനും സഹോദരനും സഹോദരപുത്രനും പിതൃവ്യനും പൂർണ്ണ പിതൃവ്യ പുത്രനുംഅനന്തരസ്വത്തില്‍ നിന്നും തടയുന്നു.")
}
